...
<YYINITIAL> "%" { return new Yytoken( 24, yytext() ); }
<YYINITIAL> "<" { return new Yytoken( 25, yytext() ); }
<YYINITIAL> "<=" { return new Yytoken( 26, yytext() ); }
<YYINITIAL> ">" { return new Yytoken( 27, yytext() ); }
<YYINITIAL> ">=" { return new Yytoken( 28, yytext() ); }
<YYINITIAL> "=" { return new Yytoken( 29, yytext() ); }
<YYINITIAL> "!=" { return new Yytoken( 30, yytext() ); }
<YYINITIAL> "&&" { return new Yytoken( 31, yytext() ); }
<YYINITIAL> "||" { return new Yytoken( 32, yytext() ); }
<YYINITIAL> "!" { return new Yytoken( 33, yytext() ); }
<YYINITIAL> "assignop" { return new Yytoken( 34, yytext() ); }
<YYINITIAL> ";" { return new Yytoken( 35, yytext() ); }
<YYINITIAL> "," { return new Yytoken( 36, yytext() ); }
<YYINITIAL> "." { return new Yytoken( 37, yytext() ); }
<YYINITIAL> "(" { return new Yytoken( 38, yytext() ); }
<YYINITIAL> ")" { return new Yytoken( 39, yytext() ); }
...
<YYINITIAL> "intconstant" { return new Yytoken( 44, yytext() ); }
<YYINITIAL> "doubleconstant" { return new Yytoken( 45, yytext() ); }
<YYINITIAL> \".*\" { return new Yytoken( 46, "stringconstant" ); }
<YYINITIAL> "booleanconstant" { return new Yytoken( 47, yytext() ); }
